...
func newRootCmd() *cobra.Command {
	...
	root := &cobra.Command{
		Use:          "vibe",
		Short:        "Manage codex worktree sandboxes",
		SilenceUsage: true,
		Long:         "vibe creates git-worktree + docker sandboxes and runs codex --yolo.",
	}
	root.PersistentFlags().StringVar(&rootOpts.sandboxRoot, "sandbox-root", "", "sandbox root path (default: <repo>/.codex-sandboxes)")
